  ...
  return (
    <Layout>
      <div className="page-container">
        ...
        <p className="page-content">Let's <a href="mailto:theingredientscollective@gmail.com?subject=Let's chat!" className="inline-link">chat about design and life!</a></p>
      </div>
    </Layout>
  )
}
