  ...
  return (
    <Layout>
      <div className="page-container">
        ...
        <p className="page-content">The Ingredients design site is a creative collective that loves to create, share, and collaborate.</p>
        <p className="page-content">We specialize in web design, UX/UI design, and innovative digital experiences.</p>
